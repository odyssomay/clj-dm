...
;; 094020/af added transposition major - minor
...
(setq *dm-main-window-title*
 (multiple-value-bind (sec min hour date month year) 
                       (get-decoded-time)
                       (format nil "Director Musices 2.7.1   compiled: ~A/~A/~A ~A:~2,'0D"
...
;;;                       :value #'(lambda nil (analyse *active-score*)) )
                    ...
                    menu-separator
                    (make-instance 'menu-item
                      :title "Transpose from major to minor"
                      :value #'(lambda nil (transpose-from-major-to-minor)) )
                    (make-instance 'menu-item
                      :title "Transpose from minor to major"
                      :value #'(lambda nil (transpose-from-minor-to-major)) )
